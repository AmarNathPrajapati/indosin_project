                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-4">Product Queries</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    ...
                                    <a href="./product_archive_date.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <!-- <span class=" pe-2">
                            ...
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                ...
                                <tbody >
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px;">
                                           <form action="../../backend/admin2/archive_product_data.php" method="post">
