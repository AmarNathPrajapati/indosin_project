...
<?php require('./agent_components/header_links.php'); ?>
    <title>Archived Contact Queries</title>
</head>
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-4">Archived Contact Queries</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    ...
                                    <a href="./contact_queries.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <!-- <span class=" pe-2">
                            ...
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                ...
                                <tbody >
                                    ...
                                    // echo $_GET['document_id12'];
                                        ...
                                        $stmt="SELECT * FROM contact_us WHERE contact_us.deleted_at IS NULL AND contact_us.archive=(?)";
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px;">
                                           <form action="../../backend/admin2/unarchive_contact_data.php" method="post">
